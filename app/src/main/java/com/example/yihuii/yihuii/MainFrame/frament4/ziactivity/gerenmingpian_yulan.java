...
public class gerenmingpian_yulan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gerenmingpian_yulan);
        initView();
        ...
        oauthWebview = (WebView) findViewById(R.id.web_gerenmingpian);
