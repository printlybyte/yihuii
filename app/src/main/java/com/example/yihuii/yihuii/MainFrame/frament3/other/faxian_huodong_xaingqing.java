...
public class faxian_huodong_xaingqing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faxian_huodong_xaingqing);
        initView();
    }
    ...
    private void initView() {
        ...
        oauthWebview = (WebView) findViewById(R.id.web_faxian_xiangqing);
