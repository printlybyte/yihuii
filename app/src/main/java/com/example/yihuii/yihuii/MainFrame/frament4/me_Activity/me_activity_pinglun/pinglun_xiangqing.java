package com.example.yihuii.yihuii.MainFrame.frament4.me_Activity.me_activity_pinglun;
...
public class pinglun_xiangqing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pinglun_xiangqing2);
        initView();
    }
    ...
    private void initView() {
        ...
        oauthWebview = (WebView) findViewById(R.id.web_pinglun);
