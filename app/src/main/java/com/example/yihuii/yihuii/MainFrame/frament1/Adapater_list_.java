...
public class Adapater_list_ extends BaseAdapter {
    private Context context;
    private List<Costom_Person> mList = new ArrayList<>();

    public Adapater_list_(List<Costom_Person> mList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
     ViewHodle viewHodle=null;
        if (convertView==null){
            convertView= LayoutInflater.from(context).inflate(R.layout.adapter_recyview_item, parent, false);
            ...
            viewHodle.text_title = (TextView) convertView.findViewById(R.id.Adapter_recy_title);
