...
public class haoyou_xiangqing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_haoyou_xiangqing);
        initView();
    }
    ...
    private void initView() {
        ...
        oauthWebview = (WebView) findViewById(R.id.webview_haoyou_xiangxi);
    ...
    private void pupupwindou() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(haoyou_xiangqing.this, "交换", Toast.LENGTH_SHORT).show();
            }
        });
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(haoyou_xiangqing.this, "添加到通讯录", Toast.LENGTH_SHORT).show();
            }
        });
